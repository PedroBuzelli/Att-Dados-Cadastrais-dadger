...
TI_PATCHES = {
    "1": ("0.3", "0.3", "0.3"), "4": ("2.4", "2.4", "1.7"), "6": ("13.4", "13.4", "11.1"),
    "7": ("1.8", "1.8", "1.8"), "8": ("0.4", "0.4", "0.3"), "9": ("2.0", "2.0", "1.8"),
    "10": ("0.8", "0.8", "0.7"), "11": ("3.1", "3.1", "2.6"), "12": ("8.9", "8.9", "7.2"),
    "14": ("0.6", "0.6", "0.6"), "15": ("0.9", "0.9", "0.6"), "16": ("3.4", "3.4", "3.4"),
    "17": ("38.2", "38.2", "32.7"), "18": ("17.2", "17.2", "15.0"), "20": ("23.6", "23.6", "14.1"),
    "21": ("6.8", "6.8", "4.3"), "24": ("45.9", "45.9", "39.1"), "25": ("22.5", "22.5", "15.3"),
    "26": ("8.0", "8.0", "6.6"), "27": ("2.3", "2.3", "2.2"), "28": ("1.1", "1.1", "1.0"),
    "29": ("7.7", "7.7", "7.2"), "30": ("10.2", "10.2", "7.2"), "31": ("12.3", "12.3", "9.3"),
    "32": ("6.1", "6.1", "4.4"), "33": ("39.3", "39.3", "33.0"), "34": ("15.2", "15.2", "13.0"),
    "37": ("15.6", "15.6", "14.4"), "38": ("2.6", "2.6", "2.5"), "39": ("8.5", "8.5", "8.0"),
    "40": ("12.5", "12.5", "11.2"), "42": ("1.9", "1.9", "1.7"), "43": ("5.3", "5.3", "4.0"),
    "45": ("3.5", "3.5", "2.6"), "46": ("14.9", "14.9", "13.1"), "47": ("0.9", "0.9", "0.6"),
    "48": ("11.4", "11.4", "5.9"), "49": ("1.6", "1.6", "1.4"), "50": ("5.5", "5.5", "4.7"),
    "51": ("0.1", "0.1", "0.1"), "52": ("0.4", "0.4", "0.4"), "57": ("19.5", "19.5", "19.5"),
    "61": ("-13.7", "-13.7", "-15.1"), "62": ("1.8", "1.8", "1.6"), "63": ("4.9", "4.9", "4.2"),
    "66": ("19.5", "19.5", "21.3"), "71": ("6.7", "6.7", "6.7"), "74": ("3.4", "3.4", "3.3"),
    ...
    "103": ("75.3", "75.3", "75.3"), "107": ("13.6", "13.6", "10.0"), "110": ("0.1", "0.1", "0.1"),
    "113": ("0.0", "0.0", "0.0"), "114": ("0.2", "0.2", "0.1"), "115": ("0.1", "0.1", "0.0"),
    "117": ("10.4", "10.4", "10.4"), "118": ("5.6", "5.6", "5.6"), "120": ("8.7", "8.7", "8.7"),
    "121": ("0.3", "0.3", "0.4"), "123": ("2.9", "2.9", "3.4"), "124": ("4.2", "4.2", "4.2"),
    "125": ("1.2", "1.2", "1.2"), "127": ("1.5", "1.5", "1.5"), "129": ("90.1", "90.1", "89.7"),
    "130": ("-88.1", "-88.1", "-88.5"), "133": ("-0.1", "-0.1", "-0.1"), "134": ("4.9", "4.9", "4.7"),
    "135": ("-3.1", "-3.1", "-3.2"), "139": ("2.1", "2.1", "1.8"), "141": ("4.5", "4.5", "4.0"),
    "143": ("21.9", "21.9", "21.4"), "144": ("-9.9", "-9.9", "-10.5"), "145": ("0.3", "0.3", "0.3"),
    "146": ("1.3", "1.3", "1.3"), "148": ("1.4", "1.4", "1.3"), "153": ("5.3", "5.3", "5.2"),
    "154": ("6.8", "6.8", "7.1"), "155": ("12.9", "12.9", "7.0"), "156": ("12.1", "12.1", "10.2"),
    "162": ("10.4", "10.4", "8.2"), "169": ("273.5", "273.5", "228.1"), "172": ("86.3", "86.3", "99.6"),
    "173": ("2.1", "2.1", "3.0"), "174": ("0.0", "0.0", "0.0"), "178": ("0.4", "0.4", "0.5"),
    "181": ("0.1", "0.1", "0.1"), "182": ("0.1", "0.1", "0.1"), "185": ("2.0", "2.0", "1.7"),
    "189": ("16.9", "16.9", "18.6"), "190": ("5.3", "5.3", "4.2"), "192": ("3.1", "3.1", "3.0"),
    "193": ("-0.7", "-0.7", "-0.7"), "203": ("0.6", "0.6", "0.4"), "215": ("0.4", "0.4", "2.2"),
    "217": ("2.4", "2.4", "2.4"), "225": ("0.1", "0.1", "0.1"), "227": ("8.4", "8.4", "5.6"),
    "229": ("13.2", "13.2", "12.9"), "241": ("0.2", "0.2", "0.2"), "249": ("0.1", "0.1", "0.1"),
    "251": ("39.2", "39.2", "37.7"), "252": ("0.1", "0.1", "0.1"), "257": ("10.9", "10.9", "10.6"),
    "261": ("3.9", "3.9", "3.5"), "262": ("1.1", "1.1", "1.2"), "267": ("9.4", "9.4", "7.6"),
    "272": ("0.3", "0.3", "0.3"), "275": ("9.2", "9.2", "9.0"), "276": ("8.6", "8.6", "8.6"),
    "277": ("0.1", "0.1", "0.1"), "278": ("0.3", "0.3", "0.2"), "279": ("1.4", "1.4", "1.2"),
    "281": ("10.3", "10.3", "10.2"), "283": ("1.5", "1.5", "1.7"), "285": ("16.1", "16.1", "11.4"),
    "286": ("45.0", "45.0", "45.0"), "287": ("42.5", "42.5", "41.9"), "290": ("0.0", "0.0", "0.0"),
    "304": ("0.3", "0.3", "0.2"), "309": ("15.5", "15.5", "15.5"), "310": ("0.3", "0.3", "0.3"),
    "311": ("1.6", "1.6", "1.8"), "312": ("0.5", "0.5", "0.5"), "314": ("0.0", "0.0", "9.7"),
    "315": ("0.0", "0.0", "0.0"),
}
...
LV_PATCHES = {
    ...
    ("83", "1"):  ("1100.21", ""),
    ("94", "1"):  ("", "185.44"),
    ("101", "1"): ("4144.97", "41449.68"),
    ("101", "2"): ("33016.59", "34635.35"),
    ("101", "3"): ("31833.35", "31833.35"),
    ("110", "1"): ("", "3472.83"),
    ("112", "1"): ("", "2422.81"),
    ("117", "1"): ("22.40", "22.40"),
}
